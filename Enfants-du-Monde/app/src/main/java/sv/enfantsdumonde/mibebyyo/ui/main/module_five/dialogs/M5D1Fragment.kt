package sv.enfantsdumonde.mibebyyo.ui.main.module_five.dialogs
...
import sv.enfantsdumonde.mibebyyo.databinding.FragmentM5D1Binding

class M5D1Fragment(
    private val onClickListener: OnClickListener
) : BottomSheetDialogFragment() {

    private lateinit var binding: FragmentM5D1Binding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentM5D1Binding.inflate(inflater)
